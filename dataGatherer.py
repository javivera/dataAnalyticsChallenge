...
def retrieve_and_save(datasetSource, datasetName,DEBUG=False):
    ...
    path = os.path.join(DATASETS_DIR,datasetName,current_year + "-" + current_month)
    ...
    with open(path + '/' + datasetName + '-' + current_date + '.csv', 'w') as f:
        ...
        for line in r.iter_lines():
            ...
            if contador > 329 and DEBUG:
                print(DEBUG)
                print('Linea número ' + str(contador))
                print(decoded_line)
...
def dataGatherer():
    ...
    print("Los datos fueron recolectados con éxito")
